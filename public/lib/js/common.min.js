function fullPage() {
  $("#js-fullpage").fullpage({
    ...
    scrollingSpeed: 1e3,
    anchors: ["", "About", "Project-1", "Project-2", "Contact"],
    navigation: !0,
    ...
    onLeave: function (a, t, e) {
      if (
        ...
        anime
          ...
          .add({
            targets: n + " .image__cover",
            translateX: [0, "110%"],
            translateZ: 0,
            easing: "easeInOutQuart",
            duration: function (a, t) {
              return 1200 - 200 * t;
            },
            offset: "-=1700",
          })
          .add({
            targets: n + " .page-num p",
            translateY: ["100%", 0],
            translateZ: 0,
            easing: "easeInOutCubic",
            duration: 1e3,
    ...
    afterRender: function () {
      $(".section").each(function (a) {
        var t = a + 1;
        $(this).addClass("fp-section-" + t);
      });
    },
  });
}
function headerColor() {
  var a = $(".barba-container").attr("data-namespace");
  $(window).on("scroll", function () {
    "top" !== a && $(window).scrollTop() > $(window).height()
...
$(function () {
  ...
  (Barba.Pjax.preventCheck = function (a, t) {
    return (
      !!($(t).attr("href") && -1 < $(t).attr("href").indexOf("#")) ||
      Barba.Pjax.originalPreventCheck(a, t)
    );
  });
var state = 0;
  ...
  $(function () {
    ...
    $(".js-menuBtn").on("click", function () {
      $(".menuIcon").toggleClass("js-menuOpen"),
        ...
        $(window).scrollTop() > a && $("header").toggleClass("js-color"),
  ...
  PageTransitionUnder = Barba.BaseTransition.extend({
    ...
    close: function () {
      return new Promise(function (a) {
        ...
        0 !== $(window).scrollTop()
          ? $("body,html").animate({ scrollTop: 0 }, 500, "swing", t.play)
          : t.play();
      });
    },
    finish: function () {
